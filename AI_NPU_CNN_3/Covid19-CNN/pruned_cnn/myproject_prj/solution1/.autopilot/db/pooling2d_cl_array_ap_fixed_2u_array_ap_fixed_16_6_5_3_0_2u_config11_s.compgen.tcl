...
set ID 288
set hasByteEnable 0
set MemName myproject_pooling2d_cl_array_ap_fixed_2u_array_ap_fixed_16_6_5_3_0_2u_config11_s_line_btde
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_data \
    op interface \
    ports { data_dout { I 32 vector } data_empty_n { I 1 bit } data_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_res \
    op interface \
    ports { res_din { O 32 vector } res_full_n { I 1 bit } res_write { O 1 bit } } \
} "
}
