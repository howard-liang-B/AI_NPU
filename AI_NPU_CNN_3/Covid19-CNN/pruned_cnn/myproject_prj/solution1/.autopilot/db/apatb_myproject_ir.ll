; ModuleID = '/mnt/Data/digital_design/AI_NPU_CNN_3/Covid19-CNN/pruned_cnn/myproject_prj/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

%"class.hls::stream" = type { %"struct.nnet::array" }
%"struct.nnet::array" = type { [3 x %struct.ap_fixed] }
%struct.ap_fixed = type { %struct.ap_fixed_base }
%struct.ap_fixed_base = type { %struct.ssdm_int }
%struct.ssdm_int = type { i16 }
%"class.hls::stream.1" = type { %"struct.nnet::array.2" }
%"struct.nnet::array.2" = type { [4 x %struct.ap_fixed] }

; Function Attrs: noinline
define void @apatb_myproject_ir(%"class.hls::stream"* %input_1, %"class.hls::stream.1"* %layer28_out) local_unnamed_addr #0 {
entry:
  %input_1_copy = alloca %"class.hls::stream", align 512
  %layer28_out_copy = alloca %"class.hls::stream.1", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %input_1, %"class.hls::stream"* nonnull align 512 %input_1_copy, %"class.hls::stream.1"* %layer28_out, %"class.hls::stream.1"* nonnull align 512 %layer28_out_copy)
  call void @apatb_myproject_hw(%"class.hls::stream"* %input_1_copy, %"class.hls::stream.1"* %layer28_out_copy)
  call fastcc void @copy_out(%"class.hls::stream"* %input_1, %"class.hls::stream"* nonnull align 512 %input_1_copy, %"class.hls::stream.1"* %layer28_out, %"class.hls::stream.1"* nonnull align 512 %layer28_out_copy)
  ret void
}
...
for.loop:                                         ; preds = %for.loop.head, %11
  ...
  %12 = bitcast %struct.ap_fixed* %src.addr5 to i8*
  %13 = call i1 @fpga_fifo_exist_2(i8* %12)
  br i1 %13, label %14, label %15

; <label>:14:                                     ; preds = %for.loop
  call fastcc void @streamcpy_hls.p0struct.ap_fixed(%struct.ap_fixed* %dst.addr4, %struct.ap_fixed* %src.addr5)
...
; <label>:15:                                     ; preds = %for.loop
  ...
  %16 = bitcast %struct.ap_fixed_base* %src.addr.06 to i8*
  %17 = call i1 @fpga_fifo_exist_2(i8* %16)
  br i1 %17, label %18, label %19

; <label>:18:                                     ; preds = %15
  call fastcc void @streamcpy_hls.p0struct.ap_fixed_base(%struct.ap_fixed_base* %dst.addr.07, %struct.ap_fixed_base* %src.addr.06)
  br label %for.loop.head
...
; <label>:19:                                     ; preds = %15
  ...
  %20 = bitcast %struct.ssdm_int* %src.addr.0.08 to i8*
  %21 = call i1 @fpga_fifo_exist_2(i8* %20)
  br i1 %21, label %22, label %23

; <label>:22:                                     ; preds = %19
  call fastcc void @streamcpy_hls.p0struct.ssdm_int(%struct.ssdm_int* %dst.addr.0.09, %struct.ssdm_int* %src.addr.0.08)
  br label %for.loop.head
...
; <label>:10:                                     ; preds = %8
  call fastcc void @"streamcpy_hls.p0struct.nnet::array.2"(%"struct.nnet::array.2"* align 512 %.01, %"struct.nnet::array.2"* %.0)
  br label %ret
...
for.loop:                                         ; preds = %for.loop.head, %11
  %for.loop.idx14 = phi i64 [ 0, %11 ], [ %for.loop.idx.next, %for.loop.head ]
  %dst.addr4 = getelementptr %"class.hls::stream.1", %"class.hls::stream.1"* %0, i32 0, i32 0, i32 0, i64 %for.loop.idx14
  %src.addr5 = getelementptr %"class.hls::stream.1", %"class.hls::stream.1"* %1, i32 0, i32 0, i32 0, i64 %for.loop.idx14
  %12 = bitcast %struct.ap_fixed* %src.addr5 to i8*
  %13 = call i1 @fpga_fifo_exist_2(i8* %12)
  br i1 %13, label %14, label %15
...
; <label>:15:                                     ; preds = %for.loop
  %src.addr.06 = getelementptr %"class.hls::stream.1", %"class.hls::stream.1"* %1, i32 0, i32 0, i32 0, i64 %for.loop.idx14, i32 0
  %dst.addr.07 = getelementptr %"class.hls::stream.1", %"class.hls::stream.1"* %0, i32 0, i32 0, i32 0, i64 %for.loop.idx14, i32 0
  %16 = bitcast %struct.ap_fixed_base* %src.addr.06 to i8*
  %17 = call i1 @fpga_fifo_exist_2(i8* %16)
  br i1 %17, label %18, label %19
...
; <label>:19:                                     ; preds = %15
  %src.addr.0.08 = getelementptr %"class.hls::stream.1", %"class.hls::stream.1"* %1, i32 0, i32 0, i32 0, i64 %for.loop.idx14, i32 0, i32 0
  %dst.addr.0.09 = getelementptr %"class.hls::stream.1", %"class.hls::stream.1"* %0, i32 0, i32 0, i32 0, i64 %for.loop.idx14, i32 0, i32 0
  %20 = bitcast %struct.ssdm_int* %src.addr.0.08 to i8*
  %21 = call i1 @fpga_fifo_exist_2(i8* %20)
  br i1 %21, label %22, label %23
...
; <label>:23:                                     ; preds = %19
  %dst.addr.0.0.011.gep12 = getelementptr %"class.hls::stream.1", %"class.hls::stream.1"* %0, i32 0, i32 0, i32 0, i64 %for.loop.idx14, i32 0, i32 0, i32 0
  %24 = bitcast i16* %dst.addr.0.0.011.gep12 to i8*
  %src.addr.0.0.010.gep13 = getelementptr %"class.hls::stream.1", %"class.hls::stream.1"* %1, i32 0, i32 0, i32 0, i64 %for.loop.idx14, i32 0, i32 0, i32 0
  %25 = bitcast i16* %src.addr.0.0.010.gep13 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %24, i8* align 1 %25, i64 2, i1 false)
  br label %for.loop.head
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0struct.nnet::array.2"(%"struct.nnet::array.2"* noalias nocapture align 512, %"struct.nnet::array.2"* noalias nocapture) unnamed_addr #3 {
entry:
  %2 = alloca %"struct.nnet::array.2"
  br label %empty

empty:                                            ; preds = %push, %entry
  %3 = bitcast %"struct.nnet::array.2"* %1 to i8*
  %4 = call i1 @fpga_fifo_not_empty_8(i8* %3)
  br i1 %4, label %push, label %ret

push:                                             ; preds = %empty
  %5 = bitcast %"struct.nnet::array.2"* %2 to i8*
  %6 = bitcast %"struct.nnet::array.2"* %1 to i8*
  call void @fpga_fifo_pop_8(i8* %5, i8* %6)
  %7 = load volatile %"struct.nnet::array.2", %"struct.nnet::array.2"* %2
  %8 = bitcast %"struct.nnet::array.2"* %2 to i8*
  %9 = bitcast %"struct.nnet::array.2"* %0 to i8*
  call void @fpga_fifo_push_8(i8* %8, i8* %9)
  br label %empty, !llvm.loop !12

ret:                                              ; preds = %empty
  %10 = bitcast %"struct.nnet::array.2"* %1 to i8*
  %11 = bitcast %"struct.nnet::array.2"* %0 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %11, i8* align 1 %10, i64 8, i1 false)
  ret void
}
...
declare void @apatb_myproject_hw(%"class.hls::stream"*, %"class.hls::stream.1"*)

define void @myproject_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream.1"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream.1"* null, %"class.hls::stream.1"* %1)
  call void @myproject_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream.1"* %1)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream.1"* null, %"class.hls::stream.1"* %1)
  ret void
}

declare void @myproject_hw_stub(%"class.hls::stream"*, %"class.hls::stream.1"*)
