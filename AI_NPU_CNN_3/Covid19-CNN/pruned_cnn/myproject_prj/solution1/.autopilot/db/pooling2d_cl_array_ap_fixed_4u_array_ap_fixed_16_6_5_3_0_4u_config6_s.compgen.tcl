...
set ID 156
set hasByteEnable 0
set MemName myproject_pooling2d_cl_array_ap_fixed_4u_array_ap_fixed_16_6_5_3_0_4u_config6_s_line_buhbi
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_res \
    op interface \
    ports { res_din { O 64 vector } res_full_n { I 1 bit } res_write { O 1 bit } } \
} "
}
