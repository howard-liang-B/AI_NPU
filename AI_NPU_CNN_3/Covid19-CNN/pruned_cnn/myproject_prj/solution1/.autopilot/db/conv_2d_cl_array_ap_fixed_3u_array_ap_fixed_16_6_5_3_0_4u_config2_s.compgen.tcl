...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { input_1_V_TDATA { I 48 vector } input_1_V_TVALID { I 1 bit } input_1_V_TREADY { O 1 bit } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { layer2_out_din { O 64 vector } layer2_out_full_n { I 1 bit } layer2_out_write { O 1 bit } } \
} "
}
