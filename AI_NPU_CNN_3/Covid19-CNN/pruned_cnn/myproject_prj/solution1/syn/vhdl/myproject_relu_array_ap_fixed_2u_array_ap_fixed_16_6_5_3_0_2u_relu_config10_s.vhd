...
entity myproject_relu_array_ap_fixed_2u_array_ap_fixed_16_6_5_3_0_2u_relu_config10_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of myproject_relu_array_ap_fixed_2u_array_ap_fixed_16_6_5_3_0_2u_relu_config10_s is 
...
attribute shreg_extract : string;
    ...
    signal i_reg_63 : STD_LOGIC_VECTOR (9 downto 0);
    signal i_3_fu_74_p2 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal tmp_41_reg_172 : STD_LOGIC_VECTOR (15 downto 0);
    signal trunc_ln155_s_reg_177 : STD_LOGIC_VECTOR (14 downto 0);
    signal out_data_22_fu_119_p3 : STD_LOGIC_VECTOR (14 downto 0);
    signal out_data_22_reg_182 : STD_LOGIC_VECTOR (14 downto 0);
    signal out_data_24_fu_131_p3 : STD_LOGIC_VECTOR (14 downto 0);
    signal out_data_24_reg_187 : STD_LOGIC_VECTOR (14 downto 0);
    ...
    signal icmp_ln1494_10_fu_126_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln41_reg_158 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_41_reg_172 <= data_dout(31 downto 16);
                tmp_reg_162 <= tmp_fu_86_p1;
                trunc_ln155_reg_167 <= trunc_ln155_fu_90_p1;
                trunc_ln155_s_reg_177 <= data_dout(30 downto 16);
            end if;
        end if;
    end process;
    ...
    i_3_fu_74_p2 <= std_logic_vector(unsigned(i_reg_63) + unsigned(ap_const_lv10_1));
    icmp_ln1494_10_fu_126_p2 <= "1" when (signed(tmp_41_reg_172) > signed(ap_const_lv16_0)) else "0";
    icmp_ln1494_fu_114_p2 <= "1" when (signed(tmp_reg_162) > signed(ap_const_lv16_0)) else "0";
    icmp_ln41_fu_80_p2 <= "1" when (i_reg_63 = ap_const_lv10_349) else "0";
    ...
    out_data_22_fu_119_p3 <= 
        trunc_ln155_reg_167 when (icmp_ln1494_fu_114_p2(0) = '1') else 
        ap_const_lv15_0;
    out_data_24_fu_131_p3 <= 
        trunc_ln155_s_reg_177 when (icmp_ln1494_10_fu_126_p2(0) = '1') else 
        ap_const_lv15_0;
    ...
    tmp_s_fu_141_p3 <= (out_data_24_reg_187 & zext_ln45_fu_138_p1);
    trunc_ln155_fu_90_p1 <= data_dout(15 - 1 downto 0);
    zext_ln45_fu_138_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(out_data_22_reg_182),16));
end behav;
