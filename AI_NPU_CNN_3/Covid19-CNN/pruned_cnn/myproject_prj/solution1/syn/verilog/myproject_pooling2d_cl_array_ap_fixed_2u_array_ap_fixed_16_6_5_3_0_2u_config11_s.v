...
module myproject_pooling2d_cl_array_ap_fixed_2u_array_ap_fixed_16_6_5_3_0_2u_config11_s (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
reg    line_buffer_Array_8_0_0_ce0;
reg    line_buffer_Array_8_0_0_we0;
wire   [15:0] line_buffer_Array_8_0_0_q0;
reg    line_buffer_Array_8_0_1_ce0;
reg    line_buffer_Array_8_0_1_we0;
wire   [15:0] line_buffer_Array_8_0_1_d0;
wire   [15:0] line_buffer_Array_8_0_1_q0;
reg    data_blk_n;
...
reg   [0:0] and_ln55_3_reg_536;
reg   [0:0] and_ln55_3_reg_536_pp0_iter3_reg;
reg   [9:0] indvar_flatten_reg_93;
wire   [9:0] add_ln109_fu_104_p2;
...
wire   [0:0] icmp_ln55_9_fu_184_p2;
reg   [0:0] icmp_ln55_9_reg_521;
...
wire   [0:0] and_ln55_3_fu_301_p2;
wire   [15:0] select_ln65_fu_318_p3;
reg   [15:0] select_ln65_reg_540;
wire   [15:0] select_ln65_16_fu_336_p3;
reg   [15:0] select_ln65_16_reg_546;
wire   [15:0] select_ln65_1_fu_354_p3;
reg   [15:0] select_ln65_1_reg_552;
wire   [15:0] select_ln65_18_fu_372_p3;
reg   [15:0] select_ln65_18_reg_558;
wire   [0:0] icmp_ln80_fu_379_p2;
reg   [0:0] icmp_ln80_reg_564;
reg   [31:0] sY_2_load_1_reg_568;
wire   [0:0] icmp_ln86_fu_393_p2;
reg   [0:0] icmp_ln86_reg_573;
wire   [15:0] select_ln65_17_fu_421_p3;
reg   [15:0] select_ln65_17_reg_578;
wire   [15:0] select_ln65_19_fu_437_p3;
reg   [15:0] select_ln65_19_reg_583;
reg    ap_block_state1;
...
reg   [31:0] ap_sig_allocacmp_sY_2_load_1;
reg   [31:0] ap_sig_allocacmp_pY_2_load_1;
reg   [31:0] ap_sig_allocacmp_pX_2_load_1;
wire   [31:0] add_ln91_fu_207_p2;
reg   [31:0] ap_sig_allocacmp_sX_2_load;
reg    ap_block_pp0_stage0_01001;
wire   [31:0] select_ln91_fu_200_p3;
wire   [0:0] icmp_ln55_8_fu_290_p2;
wire   [0:0] and_ln55_fu_296_p2;
wire   [0:0] icmp_ln55_7_fu_280_p2;
wire   [0:0] icmp_ln1496_fu_307_p2;
wire   [0:0] xor_ln1496_fu_312_p2;
wire   [0:0] icmp_ln1496_19_fu_325_p2;
wire   [0:0] xor_ln1496_19_fu_330_p2;
wire   [0:0] icmp_ln1496_21_fu_343_p2;
wire   [0:0] xor_ln1496_21_fu_348_p2;
wire   [0:0] icmp_ln1496_22_fu_361_p2;
wire   [0:0] xor_ln1496_22_fu_366_p2;
wire   [0:0] icmp_ln1496_20_fu_411_p2;
wire   [0:0] xor_ln1496_20_fu_415_p2;
wire   [0:0] icmp_ln1496_23_fu_427_p2;
wire   [0:0] xor_ln1496_23_fu_431_p2;
...
myproject_pooling2d_cl_array_ap_fixed_2u_array_ap_fixed_16_6_5_3_0_2u_config11_s_line_btde #(
    .DataWidth( 16 ),
    .AddressRange( 29 ),
    .AddressWidth( 5 ))
line_buffer_Array_8_0_0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .address0(5'd28),
...
always @ (posedge ap_clk) begin
    if (((1'd1 == and_ln55_3_fu_301_p2) & (1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln55_reg_482_pp0_iter1_reg == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'd1 == and_ln55_3_reg_536) & (1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln55_reg_482_pp0_iter2_reg == 1'd1))) begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_86)) begin
        if ((icmp_ln76_fu_190_p2 == 1'd1)) begin
            ap_sig_allocacmp_pX_2_load_1 = 32'd0;
        end else if ((icmp_ln76_fu_190_p2 == 1'd0)) begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_479)) begin
        if ((icmp_ln80_fu_379_p2 == 1'd1)) begin
            ap_sig_allocacmp_pY_2_load_1 = 32'd0;
        end else if ((icmp_ln80_fu_379_p2 == 1'd0)) begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_86)) begin
        if ((icmp_ln76_fu_190_p2 == 1'd1)) begin
            ap_sig_allocacmp_sX_2_load = 32'd0;
        end else if ((icmp_ln76_fu_190_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        line_buffer_Array_8_0_0_ce0 = 1'd1;
    end else begin
        line_buffer_Array_8_0_0_ce0 = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        line_buffer_Array_8_0_0_we0 = 1'd1;
    end else begin
        line_buffer_Array_8_0_0_we0 = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        line_buffer_Array_8_0_1_ce0 = 1'd1;
    end else begin
        line_buffer_Array_8_0_1_ce0 = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        line_buffer_Array_8_0_1_we0 = 1'd1;
    end else begin
        line_buffer_Array_8_0_1_we0 = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'd1 == and_ln55_3_reg_536_pp0_iter3_reg) & (icmp_ln55_reg_482_pp0_iter3_reg == 1'd1) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
...
assign add_ln109_fu_104_p2 = (indvar_flatten_reg_93 + 10'd1);

assign add_ln76_fu_130_p2 = (ap_sig_allocacmp_pX_2_load_1 + 32'd1);

assign add_ln80_fu_234_p2 = (ap_sig_allocacmp_pY_2_load_1 + 32'd1);

assign add_ln86_fu_450_p2 = (sY_2_load_1_reg_568 + select_ln86_fu_443_p3);

assign add_ln91_fu_207_p2 = (sX_2_load_reg_477 + select_ln91_fu_200_p3);

assign and_ln55_3_fu_301_p2 = (icmp_ln55_7_fu_280_p2 & and_ln55_fu_296_p2);

assign and_ln55_fu_296_p2 = (icmp_ln55_9_reg_521 & icmp_ln55_8_fu_290_p2);
...
always @ (*) begin
    ap_predicate_op90_write_state6 = ((1'd1 == and_ln55_3_reg_536_pp0_iter3_reg) & (icmp_ln55_reg_482_pp0_iter3_reg == 1'd1));
end

assign ap_ready = internal_ap_ready;

assign icmp_ln109_fu_110_p2 = ((indvar_flatten_reg_93 == 10'd841) ? 1'b1 : 1'b0);

assign icmp_ln1496_19_fu_325_p2 = (($signed(kernel_data_V_8_6) < $signed(shift_buffer_V_1_0_reg_493)) ? 1'b1 : 1'b0);

assign icmp_ln1496_20_fu_411_p2 = (($signed(select_ln65_reg_540) < $signed(select_ln65_16_reg_546)) ? 1'b1 : 1'b0);

assign icmp_ln1496_21_fu_343_p2 = (($signed(kernel_data_V_8_3) < $signed(p_0_reg_514)) ? 1'b1 : 1'b0);

assign icmp_ln1496_22_fu_361_p2 = (($signed(kernel_data_V_8_7) < $signed(shift_buffer_V_1_1_reg_500)) ? 1'b1 : 1'b0);

assign icmp_ln1496_23_fu_427_p2 = (($signed(select_ln65_1_reg_552) < $signed(select_ln65_18_reg_558)) ? 1'b1 : 1'b0);

assign icmp_ln1496_fu_307_p2 = (($signed(kernel_data_V_8_2) < $signed(shift_buffer_V_0_0_reg_507)) ? 1'b1 : 1'b0);

assign icmp_ln55_7_fu_280_p2 = ((ap_sig_allocacmp_sY_2_load == 32'd1) ? 1'b1 : 1'b0);

assign icmp_ln55_8_fu_290_p2 = (($signed(pY_2) > $signed(32'd0)) ? 1'b1 : 1'b0);

assign icmp_ln55_9_fu_184_p2 = (($signed(pX_2) > $signed(32'd0)) ? 1'b1 : 1'b0);

assign icmp_ln55_fu_120_p2 = ((ap_sig_allocacmp_sX_2_load == 32'd1) ? 1'b1 : 1'b0);

assign icmp_ln76_fu_190_p2 = ((add_ln76_reg_487 == 32'd29) ? 1'b1 : 1'b0);

assign icmp_ln80_fu_379_p2 = ((add_ln80_reg_530 == 32'd29) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_393_p2 = ((ap_sig_allocacmp_sY_2_load_1 == 32'd1) ? 1'b1 : 1'b0);

assign line_buffer_Array_8_0_1_d0 = {{data_dout[31:16]}};

assign res_din = {{select_ln65_19_reg_583}, {select_ln65_17_reg_578}};

assign select_ln65_16_fu_336_p3 = ((xor_ln1496_19_fu_330_p2[0:0] == 1'b1) ? kernel_data_V_8_6 : shift_buffer_V_1_0_reg_493);

assign select_ln65_17_fu_421_p3 = ((xor_ln1496_20_fu_415_p2[0:0] == 1'b1) ? select_ln65_reg_540 : select_ln65_16_reg_546);

assign select_ln65_18_fu_372_p3 = ((xor_ln1496_22_fu_366_p2[0:0] == 1'b1) ? kernel_data_V_8_7 : shift_buffer_V_1_1_reg_500);

assign select_ln65_19_fu_437_p3 = ((xor_ln1496_23_fu_431_p2[0:0] == 1'b1) ? select_ln65_1_reg_552 : select_ln65_18_reg_558);

assign select_ln65_1_fu_354_p3 = ((xor_ln1496_21_fu_348_p2[0:0] == 1'b1) ? kernel_data_V_8_3 : p_0_reg_514);

assign select_ln65_fu_318_p3 = ((xor_ln1496_fu_312_p2[0:0] == 1'b1) ? kernel_data_V_8_2 : shift_buffer_V_0_0_reg_507);
...
assign xor_ln1496_19_fu_330_p2 = (icmp_ln1496_19_fu_325_p2 ^ 1'd1);

assign xor_ln1496_20_fu_415_p2 = (icmp_ln1496_20_fu_411_p2 ^ 1'd1);

assign xor_ln1496_21_fu_348_p2 = (icmp_ln1496_21_fu_343_p2 ^ 1'd1);

assign xor_ln1496_22_fu_366_p2 = (icmp_ln1496_22_fu_361_p2 ^ 1'd1);

assign xor_ln1496_23_fu_431_p2 = (icmp_ln1496_23_fu_427_p2 ^ 1'd1);

assign xor_ln1496_fu_312_p2 = (icmp_ln1496_fu_307_p2 ^ 1'd1);

endmodule //myproject_pooling2d_cl_array_ap_fixed_2u_array_ap_fixed_16_6_5_3_0_2u_config11_s
