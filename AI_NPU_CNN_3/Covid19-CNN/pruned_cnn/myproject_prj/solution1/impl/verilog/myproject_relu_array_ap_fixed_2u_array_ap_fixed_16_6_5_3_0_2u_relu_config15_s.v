...
module myproject_relu_array_ap_fixed_2u_array_ap_fixed_16_6_5_3_0_2u_relu_config15_s (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
reg   [15:0] tmp_40_reg_172;
reg   [14:0] trunc_ln155_9_reg_177;
wire   [14:0] out_data_19_fu_119_p3;
reg   [14:0] out_data_19_reg_182;
wire   [14:0] out_data_21_fu_131_p3;
reg   [14:0] out_data_21_reg_187;
reg    ap_block_state1;
...
wire   [0:0] icmp_ln1494_9_fu_126_p2;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln41_reg_158 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_40_reg_172 <= {{data_dout[31:16]}};
        tmp_reg_162 <= tmp_fu_86_p1;
        trunc_ln155_9_reg_177 <= {{data_dout[30:16]}};
...
assign i_2_fu_74_p2 = (i_reg_63 + 8'd1);

assign icmp_ln1494_9_fu_126_p2 = (($signed(tmp_40_reg_172) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_fu_114_p2 = (($signed(tmp_reg_162) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln41_fu_80_p2 = ((i_reg_63 == 8'd144) ? 1'b1 : 1'b0);

assign out_data_19_fu_119_p3 = ((icmp_ln1494_fu_114_p2[0:0] == 1'b1) ? trunc_ln155_reg_167 : 15'd0);

assign out_data_21_fu_131_p3 = ((icmp_ln1494_9_fu_126_p2[0:0] == 1'b1) ? trunc_ln155_9_reg_177 : 15'd0);
...
assign tmp_s_fu_141_p3 = {{out_data_21_reg_187}, {zext_ln45_fu_138_p1}};

assign trunc_ln155_fu_90_p1 = data_dout[14:0];

assign zext_ln45_fu_138_p1 = out_data_19_reg_182;

endmodule //myproject_relu_array_ap_fixed_2u_array_ap_fixed_16_6_5_3_0_2u_relu_config15_s
